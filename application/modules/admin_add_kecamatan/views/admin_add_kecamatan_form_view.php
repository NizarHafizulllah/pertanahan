		...
		<div class="box box-primary">
			...
			<div class="box-body">
				...
				<div class="form-group">
					...
					<input type="text" name="nama_camat" class="form-control" placeholder="Nama Camat . ." id="nama_camat">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<input type="text" name="jabatan_camat" placeholder="Jabatan Camat" class="form-control" id="jabatan_camat">
				</div>
			</div>
		</div>
		<!--  -->
