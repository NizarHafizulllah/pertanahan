...
?>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-9">
        ...
        <input type="text" id="username" name="username" class="form-control input-style" value="<?php echo $userdata['username'] ?>" disabled>
      </div>
    </div>
    <div class="form-group">
      ...
      <div class="col-sm-9">
        ...
        <input type="text" id="no_hp" name="no_hp" class="form-control input-style" value="<?php echo $userdata['no_hp'] ?>" disabled>
      </div>
    </div>
      ...
      <!--form-->
                 ...
                 <form id="change_password" class="form-horizontal" method="post" action="<?php echo site_url('admin_profil/cek_password'); ?>" role="form">     
      <div class="box box-primary" id="bagian_form">
            <div class="box-header with-border">
...
<?php 
$this->load->view("pengepul_profile_view_js");
?>