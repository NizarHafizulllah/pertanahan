		...
		<div class="box box-primary">
			...
			<div class="box-body">
				...
				<div class="form-group">
					...
					<input type="text" name="kepala_desa" class="form-control" placeholder="Nama Kepala Desa . ." id="kepala_desa">
				</div>
				<!-- <div class="form-group">
				...
				<div class="form-group">
					...
					<input type="text" name="jabatan_kades" placeholder="Jabatan Kepala Desa" class="form-control" id="jabatan_kades">
				</div>
			</div>
		</div>
		<!--  -->
